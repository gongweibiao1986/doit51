...
//        env.setRuntimeMode(RuntimeExecutionMode.STREAMING);
        ...
        DataStream<String> streamSource = env.readTextFile("data/transformation_input/");
        /**
         * map算子
         */
...
//        filtered.print();
        ...
        SingleOutputStreamOperator<UserFriendInfo> flatten = beanStream.flatMap(new FlatMapFunction<UserInfo, UserFriendInfo>() {
            @Override
...
//                .maxBy(3).print();
         ...
         *
         */
        SingleOutputStreamOperator<Tuple4<Integer, String, String, Integer>> reduceResult = tuple4Stream.keyBy(tp -> tp.f2).reduce(new ReduceFunction<Tuple4<Integer, String, String, Integer>>() {
            /**
             *
